...
<div class="ul" id="divid">
    <ul>
        ...
        <li class="active"><a href="/yibo/index.php/Home/Pc/pos"  style="color: #fff;">座位报表</a></li>
...
<div id="righti">
    ...
    <form method="post" action="/yibo/index.php/Home/Pc/user" style="width: 500px;float: left;">
        <div class='input-group date'  style="width: 300px;float: left">
            <input type='text' class="form-control" name="login" placeholder="输入客户账号进行查询"/>
    ...
    <form method="post" action="/yibo/index.php/Home/Pc/user">
    ...
    <table class="table table-bordered" id="table">
        ...
        <th><?php $zong=$sum["put"]-$sum["out"]+$sum["give"]+$sum["turn"]-$sum["coturn"]; echo ($zong); ?></th>
        <th><?php $zong=$sum["put"]-$sum["out"]; echo ($zong); ?></th>
        </tfoot>
    </table>
</div>
