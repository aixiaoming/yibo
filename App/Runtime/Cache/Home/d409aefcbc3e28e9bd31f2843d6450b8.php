...
<div class="ul" id="divid">
    <ul>
        ...
        <li class="active"><a href="/yibo/index.php/Home/Pc/mac"  style="color: #fff;">机器报表</a></li>
...
<div id="righti">
    ...
    <form method="post" action="/yibo/index.php/Home/Pc/mac" style="float: left;">
            <div class="input-group" style="float: left;width: 300px;margin-right: 20px;">
                ...
                <select id="input2" class="form-control" name="mac">
                    <option><?php echo ($now); ?></option>
                    <?php if(is_array($mac)): $i = 0; $__LIST__ = $mac;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option><?php echo ($vo["mac"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        <div class="input-group" style="float: left;width: 300px;margin-right: 20px;">
                <span class="input-group-addon" id="basic-addon1">座位编号</span>
                <select id="input3" class="form-control" name="pos">
                    <option><?php echo ($nowpos); ?></option>
                    <option>全部位置</option>
                    <?php if(is_array($pos)): $i = 0; $__LIST__ = $pos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option><?php echo ($vo["position"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
